...
class MySQLWrapper extends DBWrapper {
    ...
    public function delete_data($table_name, $where = 1){
        $statement = Functions::replace_tokens($this->delete_statement, array('TABLE_NAME' => "`" . $table_name . "`", 'WHERE' => $where));
    ...
    public function insert_data($table_name, $fields_data){
        ...
        $statement = Functions::replace_tokens($this->insert_statement, array('TABLE_NAME' => $table_name, 'FIELDS' => $fields, 'VALUES' => $data));
    ...
    public function select_data($table, $fields, $where = null, $limit = null, $order = null, $group = null, $join = null){
        ...
        $statement = Functions::replace_tokens($this->select_statement, array('TABLE_NAME' => "$table_name", 'FIELDS' => $field_string, 'WHERE' => $where_string, 'LIMIT' => $limit_string, 'ORDER' => $order_string, 'GROUP' => $group_string, 'JOINS' => $join));
        //echo $statement;
        $success = $this->execute($statement);
    ...
    public function update_data($table_name, $fields_data, $where, $literal = false){
        ...
        $statement = Functions::replace_tokens($this->update_statement, array('TABLE_NAME' => $table_name, 'FIELDS' => $field_string, 'WHERE' => $where));
        //echo $statement;
        $success = $this->execute($statement);
    ...
    public function build_joins($type, $table, $fields) {
        ...
        $statement = Functions::replace_tokens($this->join_statement, array('TYPE' => $type, 'TABLE_NAME' => "$table_name", 'FIELD_1' => $fields[0], 'FIELD_2' => $fields[1]));
